...
/** @file Utility.hpp
 *
 *  This file contains odds and ends needed by the SDE that are too small to
 *  warrant their own header/source files and do not reasonably fit in
 *  elsewhere.
 *
 ...
 *
 *  It's natural for users of the SDE to input strings as string literals,
 *  *i.e.*, things like `"a string literal"`. Particularly from the
 ...
 *         reference.
 *
 *  When forwarding arguments in the SDE we often need to take special care
 *  if the user has told us that a particular input should be taken by const
