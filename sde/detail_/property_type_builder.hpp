        ...
        */
        ...
        private:
            ...
            */
            ...
            std::tuple<std::optional<ErasedTypes>...> m_values_;
        };

        #define BUILDER_PARAMS template<typename ElementType, typename...ErasedTypes>
        #define BUILDER_TYPE PropertyTypeBuilder<ElementType, ErasedTypes...>
        ...
        auto BUILDER_TYPE::add_field(type::key key, U&& value) {
            static_assert(
                std::is_same_v<T, ModuleInput>,
                "Returns cannot have a default value"
            );
