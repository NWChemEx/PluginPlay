...
/* This file contains tests for the ModuleOutput and ModuleOutputBuilder classes.
 * The ModuleOutputBuilder class is dependent on the ModuleOutput class hence we
 * first establish that the ModuleOutput class is working correctly before
 * testing the ModuleOutputBuilder class. Testing the latter is accomplished by
 * reusing the check_state functions from the ModuleOutput class tests to check
 * the state of the ModuleOutput instance we are building.
 */
