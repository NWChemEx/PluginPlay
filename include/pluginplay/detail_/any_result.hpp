...
public:
     ...
     */
    template<typename Archive, typename = std::enable_if_t<
                                 parallelzone::is_output_archive_v<Archive>>>
     ...
     */
    template<typename Archive, typename = std::enable_if_t<
                                 parallelzone::is_input_archive_v<Archive>>>
...
template<typename Archive,
         typename = std::enable_if_t<parallelzone::is_input_archive_v<Archive>>>
