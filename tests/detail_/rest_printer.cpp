...
TEST_CASE("reSTPrinter : operator<<") {
    ...
    //        const auto sen = "This is a short sentence under 80 characters
    //        long"; p << sen; corr << sen << " " << std::endl; REQUIRE(ss.str()
    //        == corr.str());
    //    }
    //    SECTION("Long sentence") {
    //        const auto p1 = "This is a long sentence that exceeds 80
    //        characters in "
    //                        "length because I am not ";
    //        const auto p2 = "being even remotely terse while writing it out on
    //        the "
    //                        "computer screen.";
    //        p << p1 << p2;
    //        corr << p1 << std::endl << p2 << " " << std::endl;
    //        REQUIRE(ss.str() == corr.str());
    //    }
    SECTION("80+ character word") {
        ...
        p << p1 << p2;
        corr << p1 << std::endl << std::endl << p2 << " " << std::endl;
        REQUIRE(ss.str() == corr.str());
    }
}
